  ...
  ${active
    ...
    : `<div class="row" style="align-items:flex-end">
      ...
      ${AppState.autoSessionEnabled ? `<div class="row" style="align-items:center;margin-top:10px;flex-wrap:wrap">
        ...
        <div style="flex:1;min-width:240px;font-size:11px;color:var(--muted)">Isso é o <strong>máximo</strong> que ele espera — em DG cujo tempo por run ele conhece, fecha antes: <strong>meia run sem drop</strong> já conta como travou ou acabou, e depois das ${DAILY_RUN_LIMIT} runs do dia a paciência cai pela metade de novo. Pode deixar curto sem medo: se os drops voltarem dentro de ${AppState.sessionIdleCloseMinutes * 3}min, ele <strong>retoma a mesma sessão</strong> — o intervalo parado não entra no tempo.</div>
      </div>` : ''}
