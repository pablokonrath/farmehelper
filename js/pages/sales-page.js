...
<div class="g3" style="margin-bottom:12px">
  ...
  <div class="kpi"><div class="kpi-lbl">Valor em estoque</div><div class="kpi-val" style="color:${getAlzTierColor(summary.stockValue)}" title="${formatNumber(summary.stockValue)} Alz">${formatAlzGamer(summary.stockValue)}</div><div class="kpi-sub">dropado − vendido, ainda parado</div></div>
</div>`;
