...
${topic('ti-coins', 'Cálculo de farme (preços & itens rastreados)', `
  ...
  ${li([
    ...
    '<strong>Ficha de evento não conta como Alz.</strong> Fragmento e afins continuam aparecendo no log e nos itens da sessão — você vê o que caiu — mas valem zero em toda conta do app. Isso não é configuração sua e não precisa cadastrar nada: é regra fixa, porque item que nunca vira dinheiro contando como farme infla o total do dia e faz escolher a DG errada. E aconteceria sozinho, já que o item pega o preço de referência da comunidade mesmo sem você cadastrar preço nenhum.',
