...
export async function loadPersistedState() {
  ...
  AppState.deletedSessions = appSettings.deletedSessions ?? [];
...
export function saveDeletedSessions() {
  return put('app-settings.php', { deletedSessions: AppState.deletedSessions });
}

export function saveSessionIdleCloseMinutes() {
  return put('app-settings.php', { sessionIdleCloseMinutes: AppState.sessionIdleCloseMinutes });
}
...
export function saveRushMonthlyBudget() {
  return put('app-settings.php', { rushMonthlyBudgetAlz: AppState.rushMonthlyBudgetAlz });
}
